...
export default function HelpPage() {
  return (
    <section className="help-page">
      <header>
        <div><span>首次使用</span><h1>帮助</h1></div>
      </header>
      ...
      <div className="settings-group">
        ...
        <ul className="help-links">
          <li>
            <a href={helpLinks.apiKey} target="_blank" rel="noopener noreferrer">
              <ExternalLink size={13} /> 获取 API Key
            </a>
          </li>
          <li>
            <a href={helpLinks.workspaceId} target="_blank" rel="noopener noreferrer">
              <ExternalLink size={13} /> 获取应用与业务空间 ID
            </a>
          </li>
          <li>
            <a href={helpLinks.audioApi} target="_blank" rel="noopener noreferrer">
              <ExternalLink size={13} /> 音频生成接口说明
            </a>
          </li>
          <li>
            <a href={helpLinks.console} target="_blank" rel="noopener noreferrer">
